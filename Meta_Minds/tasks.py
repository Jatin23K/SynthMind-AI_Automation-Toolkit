...
3. Generate exactly 10 distinct, meaningful, and diverse analytical questions.
...
{sample_string}""",
            ...
            expected_output=f"""A numbered list (1. 2. etc.) of exactly 10 analytical questions based *only* on the '{name}' dataset.
...
**Constraints:**
1. Generate exactly 5-7 meaningful and diverse analytical questions.
...
{comparison_sample_string}""",
        ...
        expected_output="""A numbered list (1. 2. etc.) of 5-7 analytical questions that compare and contrast the provided datasets.
