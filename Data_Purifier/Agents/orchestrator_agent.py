...
class OrchestratorAgent:
    ...
    def __init__(self, process_recorder_agent, config: Dict):
        ...
        self.data_cleaner_agent = CleanerAgent(config=self.config)
        self.cleaning_validator_agent = CleaningValidatorAgent(config=self.config)
        self.data_modifier_agent = DataModifierAgent(config=self.config)
        self.modification_validator_agent = ModificationValidatorAgent(config=self.config)
        self.data_transformer_agent = TransformerAgent(config=self.config)
        self.transformation_validator_agent = TransformationValidatorAgent(config=self.config)
